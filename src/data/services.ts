...
export const plumbingServices: Service[] = [
  {
    ...
    shortDescription:
      "Eliminamos obstrucciones en tuberías y desagües con equipos especializados para restaurar el flujo normal del agua.",
    longDescription:
      "Nuestro servicio de destape de tuberías y desagües utiliza técnicas profesionales y equipos especializados para eliminar todo tipo de obstrucciones. Ya sea en cocinas, baños, lavamanos o desagües principales, contamos con herramientas como sondas eléctricas, hidrojet y cámaras de inspección para identificar y resolver el problema de raíz. Garantizamos un trabajo limpio, rápido y con resultados duraderos para que tu sistema de drenaje funcione como nuevo.",
    icon: "pipe",
    category: "plomeria",
    image: "/Destape.jpg",
  ...
  },
  {
    ...
    shortDescription:
      "Detectamos y reparamos fugas de agua visibles y ocultas, evitando daños mayores en tu hogar.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Instalamos y reemplazamos griferías, lavamanos, sanitarios y accesorios de baño con acabados profesionales.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Conectamos e instalamos lavadoras y calentadores de agua con todas las conexiones hidráulicas necesarias.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Reparamos o reemplazamos tuberías dañadas, oxidadas o con fugas para mantener tu sistema hidráulico en óptimas condiciones.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription: "Localizamos problemas internos en tuberías con tecnología de inspección por cámara sin romper paredes.",
  ...
  },
  {
    ...
    shortDescription: "Detección electrónica de fugas de agua no visibles mediante equipos de ultrasonido (geófono).",
...
export const electricalServices: Service[] = [
  {
    ...
    shortDescription:
      "Instalamos y reemplazamos tomacorrientes e interruptores de forma segura y profesional.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Diagnosticamos y solucionamos cortocircuitos, bajones de energía y todo tipo de fallas eléctricas.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Montamos e instalamos lámparas, ventiladores de techo y sistemas de iluminación en tu hogar.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Realizamos inspección, limpieza y mantenimiento preventivo de tableros eléctricos residenciales.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Realizamos tendido de cableado eléctrico e instalación segura de duchas eléctricas.",
    longDescription:
